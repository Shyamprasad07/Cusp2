...
class Letstart2 extends StatefulWidget {
  @override
  State<Letstart2> createState() => _Letstart2State();
}
class _Letstart2State extends State<Letstart2> {
  late BuildContext ctx;
  bool isChecked = false;
  String?  sGender;
  List<dynamic> GenderList = ["Man", "Woman","Transgender","Non-binary"];
