    ...
    return [
      BottomNavigationBarItem(
        icon: SvgPicture.asset(
          "assets/bn_homebttn.svg",
          color: index == 0 ? Clr().primaryColor : Clr().black2,
        ),
         label: 'home',
      ...
      BottomNavigationBarItem(
        icon: SvgPicture.asset(
          "assets/bn_around_you.svg",
          color: index == 1 ? Clr().primaryColor : Clr().black2,
        ),
        label: 'around',
      ...
      BottomNavigationBarItem(
        icon: SvgPicture.asset(
          "assets/chat_bn.svg",
          color: index == 2 ? Clr().primaryColor : Clr().black2,
        ),
        label: 'chat',
      ),
      BottomNavigationBarItem(
        icon: SvgPicture.asset(
          "assets/bn_like.svg",
          color: index == 3 ? Clr().primaryColor : Clr().black2,
        ),
        label: 'mymatches',
